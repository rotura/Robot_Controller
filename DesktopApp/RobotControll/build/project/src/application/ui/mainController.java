...
public class mainController
    ...
    @FXML
    private StackedBarChart<?, ?> humidity;
	...
	// Sensor de humedad
		...
		hum.getData().add(new XYChart.Data("10:01", 20));
		hum.getData().add(new XYChart.Data("10:02", 21));
		hum.getData().add(new XYChart.Data("10:03", 22));
		hum.getData().add(new XYChart.Data("10:04", 19));
		hum.getData().add(new XYChart.Data("10:05", 21));
